...
// filter is the hard offset shadow, pressed flat on :active.
...
// Dark variant (.pf-signout, .pf-follow.on): ink fill, yellow offset shadow.
export const notchDark =
  "!bg-[#2c2c2c] !text-white [filter:drop-shadow(4px_4px_0_#F7DF02)] active:[filter:drop-shadow(2px_2px_0_#F7DF02)]"
// .pf-mini-btn — smaller notch button; .ghost = grey.
export const miniBtn = "px-[14px] py-[8px] text-[12px]"
export const miniGhost = "!bg-[#e7e7e7] !text-[#222] [filter:drop-shadow(3px_3px_0_#bbb)] active:[filter:drop-shadow(2px_2px_0_#bbb)]"
